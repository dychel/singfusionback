...
public class FaqController {
    ...
    public ResponseEntity<ResponseMessage> findByEtapes(@PathVariable(value = "categorie") String categorie){
        List<Faq> faqs = faqService.findFaqBytacorgie(categorie);
        return new ResponseEntity<ResponseMessage>(new ResponseMessage("ok", "Faq trouvé", faqs), HttpStatus.OK);
    }
